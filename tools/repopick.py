...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        ...
        patches from InvictrixROM's Gerrit instance 
(or any gerrit instance of your choosing)
    ...
    default_revision = xml_root.findall('.//*[@name="invictrix"]')[0].get('revision').split('/')[-1]
